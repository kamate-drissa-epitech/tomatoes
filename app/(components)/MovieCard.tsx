...
export default function MovieCard({ poster, title, releaseDate, movieId, movie }) {
  ...
  return (
    <div className="card cursor-pointer mb-5 shadow-[0px_4px_16px_px_#367E08] h-[400px] w-[280px] group gap-[0.5em] rounded relative flex justify-end flex-col p-[1.5em] z-[1] overflow-hidden">
      ...
      <div class="h-fit w-full"></div>

      <div class="flex justify-left items-center h-fit w-full gap-[1.5em]">
        <div class="w-fit h-fit flex justify-left gap-[0.5em]"></div>
      </div>
      <div class="flex justify-center items-center h-fit w-fit gap-[0.5em]"></div>
    </div> */}
    ...
    //   className="card-container w-[270px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-5"
    // >
    //   <a href="#">
    //     <img
